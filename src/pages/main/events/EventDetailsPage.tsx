      ...
      <div className="space-y-8 mt-20 mb-20">
        ...
        <div className="flex flex-wrap gap-4 justify-between items-center">
          {isPastEvent ? (
            <div className="flex gap-3">
              <button
                className="bg-white/10 hover:cursor-not-allowed text-gray-500 px-6 py-3 rounded-full disabled:opacity-50 transition-colors shadow-sm font-medium"
                onClick={() => {}}
                type="button"
                disabled
              >
              ...
              <button
                className="border border-white/30 text-white px-3 py-1 rounded-full hover:bg-white/10 transition-colors shadow-sm hover:shadow flex items-center"
                onClick={() => {}}
                type="button"
            ...
            <div className="flex gap-3">
              <button
                className="bg-white text-black px-6 py-3 rounded-full hover:bg-gray-200 transition-colors shadow-sm hover:shadow font-medium"
                onClick={() => {}}
                type="button"
              >
                Register Now
              ...
              <button
                className="bg-white/10 border border-white/20 text-white px-6 py-3 rounded-full hover:bg-white/20 transition-colors shadow-sm hover:shadow flex items-center"
                onClick={() => {}}
                type="button"
              >
                <Share2 className="w-5 h-5 mr-2" />
                ...
                <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                  <dl className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                    <div>
                      ...
                      <dd className="mt-1 text-white">{event.date}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-400">
                        Time
                      </dt>
                      <dd className="mt-1 text-white">{event.time}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-400">
                        Location
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-white">{event.type}</dd>
                    </div>
                    <div>
                      <dt className="text-sm font-medium text-gray-400">
                        Organizer
                    ...
                    <div>
                      ...
                      <dd className="mt-1 text-white">English</dd>
                    </div>
                  </dl>
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {event.speakers.map((speaker) => (
                    <div
                      ...
                      className="bg-white/5 rounded-xl overflow-hidden border border-white/10 shadow-sm hover:shadow-md transition-shadow"
                    >
                      <div className="aspect-w-16 h-96 bg-white/5">
                        <img
          ...
          {activeTab === "discussion" && (
            ...
            >
              ...
              <div className="bg-white/5 border border-white/10 p-6 rounded-xl mb-6">
                ...
                <textarea
                  className="w-full p-3 border border-white/20 bg-transparent text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
                  rows={4}
