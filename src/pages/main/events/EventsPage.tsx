          ...
          <div className="mb-8">
            <div className="rounded-2xl overflow-hidden bg-white/5 border border-white/10">
              ...
              <div className="p-6 space-y-4">
                <div className="animate-pulse bg-white/10 h-6 w-1/4 rounded"></div>
                <div className="animate-pulse bg-white/10 h-8 w-3/4 rounded"></div>
                <div className="animate-pulse bg-white/10 h-20 w-full rounded"></div>
                <div className="flex justify-between">
                  <div className="animate-pulse bg-white/10 h-6 w-1/3 rounded"></div>
                  <div className="animate-pulse bg-white/10 h-10 w-1/4 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
