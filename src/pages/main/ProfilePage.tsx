...
const ProfilePage = () => {
    ...
    return (
      <div className="responsive-container mt-16">
        <div className="space-y-8 mt-20 mb-20">
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-12 flex flex-col items-center justify-center text-center shadow-sm">
    ...
    return (
      <div className="responsive-container mt-16">
        <div className="space-y-8 mt-20 mb-20">
          ...
          <div className="bg-white/5 shadow-sm border-b border-white/10 overflow-hidden rounded-t-2xl">
            {/* Profile Header */}
            <div className="relative h-48 bg-gradient-to-r from-blue-700 via-purple-700 to-red-700 rounded-2xl">
              <div className="absolute -bottom-16 left-8">
                <div className="h-32 w-32 rounded-full border-4 border-black overflow-hidden bg-black">
                  <img 
                  ...
                  <div>
                    ...
                    {publicProfileData.location && (
                      <div className="flex items-start gap-2 mb-3">
                        ...
                        <span className="text-gray-300">{publicProfileData.location}</span>
                      </div>
                    )}
  ...
  return (
    <div className="responsive-container mt-16 bg-background text-foreground transition-colors duration-500">
      {/* Image Modal */}
      {showImageModal && (
      ...
      <div className="space-y-8 mt-20 mb-20">
          ...
          {!isEditing ? (
            ...
            <div className="mt-10 flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-2 bg-accent text-foreground px-3 py-1 rounded-3xl hover:bg-accent/80 transition-colors"
              >
                <X size={16} /> Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="flex items-center gap-2 bg-primary text-primary-foreground px-3 py-1 rounded-3xl hover:opacity-90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
              >
        ...
        {saveError && (
          <div className="bg-red-500/10 border border-red-500/50 text-red-500 px-4 py-3 rounded-xl relative mb-6 backdrop-blur-sm" role="alert">
          ...
          <div className="relative h-48 bg-gradient-to-r from-blue-700 via-purple-700 to-red-700 rounded-2xl">
            <div className="absolute -bottom-16 left-8">
              <div className="relative">
                <div className="h-32 w-32 rounded-full border-4 border-background overflow-hidden bg-background shadow-xl">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-accent border border-border rounded-2xl focus:outline-none focus:ring-1 focus:ring-primary text-foreground"
                      />
                    </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="inline-block bg-primary/10 text-primary px-3 py-1 rounded-full text-sm font-medium border border-primary/20">
                    ...
                    {(user?.role === 'admin' || user?.role === 'super' || user?.role === 'moderator') && (
                      <div className="mt-6 p-4 bg-accent/50 rounded-lg border border-border">
                        <h3 className="text-lg font-medium mb-2 text-foreground">Admin Access</h3>
                        ...
                        <div className="flex flex-col space-y-2">
                          <a 
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-xl transition-all hover:opacity-90 shadow-md"
                          >
                            <Shield size={16} />
                            Admin Dashboard
                          </a>
                          {(user?.role === 'admin' || user?.role === 'super') && (
                            <a 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="flex items-center gap-2 bg-accent text-foreground px-4 py-2 rounded-xl transition-all hover:bg-accent/80 border border-border"
                            >
                              <Users size={16} />
                              User Management
                            </a>
                  ...
                  {/* Contact Information */}
                  <div>
                    <h3 className="text-sm font-bold text-foreground mb-3 uppercase tracking-wider">Contact Information</h3>
                    ...
                    <div className="mt-6">
                      <h3 className="text-sm font-bold text-foreground mb-3 uppercase tracking-wider">Account Information</h3>
                      <p className="text-muted-foreground text-sm">
                        <span className="font-medium text-foreground">Joined:</span> {formatDate(profileData?.profile?.created_at || null)}
                      </p>
                    </div>
                    ...
                    {Object.keys(profileData?.profile?.social_links || {}).length > 0 && (
                      <div className="mt-6">
                        <h3 className="text-sm font-bold text-foreground mb-3 uppercase tracking-wider">Social Links</h3>
                        <ul className="space-y-3">
                          {Object.entries(profileData?.profile?.social_links || {}).map(([platform, url]) => (
                            url && (
                              <li key={platform} className="flex items-center gap-2 text-muted-foreground">
        ...
        <section className="bg-card border border-border rounded-2xl shadow-sm overflow-hidden mt-8 transition-colors">
          <div className="p-6">
                ...
                {loadingThreads ? (
                  ...
                  <div className="text-center text-red-500 py-8">
                    ...
                    <button
                      ...
                      className="mt-2 text-primary hover:underline transition-colors"
                    >
                      Try Again
                    </button>
                  </div>
