  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <div className="max-w-md w-full space-y-8 backdrop-blur-sm p-8 rounded-3xl shadow-lg z-10 relative">
        ...
        >
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-md mb-2 relative block w-full px-3 py-3 border border-white/20 bg-white/5 placeholder-gray-400 text-white focus:outline-none focus:ring-white focus:border-white focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-md relative block w-full px-3 py-3 border border-white/20 bg-white/5 placeholder-gray-400 text-white focus:outline-none focus:ring-white focus:border-white focus:z-10 sm:text-sm"
          ...
          <div>
            <button
              type="submit"
              disabled={isLoading}
              className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-full text-black bg-white hover:bg-gray-200 disabled:opacity-50 transition-all duration-300"
            >
        ...
        >
          <p 
            className={`mb-4 text-center text-sm text-gray-400 transition-all duration-700 transform ${visible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
            style={{ transitionDelay: '300ms' }}
          >
            New member?{' '}
            <Link to="/register" className="underline font-medium text-white hover:text-gray-300">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-transparent text-gray-400 rounded-md">Or continue with</span>
            </div>
          </div>
          ...
          <div className="mt-6">
            <button
              ...
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-xl shadow-sm text-sm font-medium text-black bg-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-all duration-300"
            >
