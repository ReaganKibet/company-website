...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black">
      ...
      <GradientBackground
        colors={['#000000', '#111111', '#050505', '#000000']}
        duration={20}
      />
      ...
      <div className="max-w-md w-full space-y-6 backdrop-blur-sm p-8 rounded-3xl shadow-lg z-10 relative">
        <div>
          ...
          <p 
            className={`mt-1 text-center text-sm text-gray-400 transition-all duration-700 transform ${visible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
        ...
        >
          <div className="rounded-md -space-y-px">
            <div>
              ...
              <input
                ...
                className="appearance-none rounded-xl relative block w-full px-3 py-2 mb-1 border border-white/20 bg-white/5 placeholder-gray-400 text-white focus:outline-none focus:ring-white focus:border-white focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                className={`appearance-none rounded-xl relative block w-full px-3 py-2 mb-1 border ${
                  formData.password && !passwordValid ? 'border-red-500' : 'border-white/20'
                } bg-white/5 placeholder-gray-400 text-white focus:outline-none focus:ring-white focus:border-white focus:z-10 sm:text-sm`}
          ...
          >
            <button
              type="submit"
              disabled={isLoading}
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-black bg-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white transition-all duration-300 disabled:opacity-50"
            >
          ...
          <div className="mt-4 grid grid-cols-1 gap-3">
            <div className="flex w-full justify-center">
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-3xl bg-white/5 px-4 py-2 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-white/20 hover:bg-white/10 focus:outline-offset-0 w-full max-w-[300px]"
              >
        ...
        <div 
          className={`mt-4 text-center text-xs text-gray-400 transition-all duration-700 transform ${visible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
          style={{ transitionDelay: '700ms' }}
        >
          By signing up, you agree to our{' '}
          <a href="/terms-and-conditions" rel="noopener noreferrer" target="_blank" className="text-white hover:text-gray-300">Terms of Service</a>{' '}
          and{' '}
          <a href="/policy" rel="noopener noreferrer" target="_blank" className="text-white hover:text-gray-300">Privacy Policy</a>
        </div>
        ...
        >
          <Link 
            to='/' 
            className="inline-flex items-center text-sm text-white hover:text-gray-300 font-medium transition-all duration-300"
            >
