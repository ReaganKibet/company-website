...
export const EventCard: React.FC<EventCardProps> = ({ event }) => {
  ...
  return (
    <motion.div 
      className="overflow-hidden transition-all hover:shadow-md flex flex-col h-full bg-white/5 border border-white/10 rounded-2xl"
    >
    ...
    <div className="p-4 flex-grow flex flex-col">
      ...
      <div className="flex items-center justify-between mt-auto pt-3">
        ...
        <Link to={`/events/${event.public_id}`} className="text-white text-xs font-medium flex items-center hover:underline">
